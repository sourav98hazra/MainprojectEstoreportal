...
$query="UPDATE users_items ui SET status='Confirmed' WHERE ui.id='$user';";
...
$upno=$row[2];
    /* @var $uid type */
    $sms="Dear $uname with id $uid , your recent order with order id  {$user} of product {$pname} is Confirmed by the owner and amount of RS.{$dprice}' to be Paid by delivery,Thankyou!";
    
if(mysqli_query($conn, $query))
{
 
   $str='Your order is confirmed and buyer will be notified now!good luck!';
...
<html>
  <head>
    <title>ORDER IS CONFIRMED SUCCESSFULLY!</title>
